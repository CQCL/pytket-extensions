...
shutil.copy(
    "_metadata.py",
    os.path.join("pytket", "extensions", "stim", "_metadata.py"),
)
...
setup(
    ...
    description="Extension for pytket, providing access to the Stim Clifford simulator",
    long_description=open("README.md").read(),
    long_description_content_type="text/markdown",
    license="Apache 2",
    packages=find_namespace_packages(include=["pytket.*"]),
    include_package_data=True,
    install_requires=["pytket == 0.17.0rc0", "stim ~= 1.4"],
    classifiers=[
        "Environment :: Console",
